            ...
            public void onDialogStateChanged(final DialogState dialogState) {
                ...
                switch (dialogState) {
                    ...
                    case SPEAKING:
                        ...
                        break;
                    case THINKING:
                        com.baidu.duer.dcs.sample.sdk.wakeup.LogUtil.i(TAG, "思考中  2");
        ...
        switch (view.getId()) {
            ...
            case R.id.sendBtn:
                ...
                if (!NetWorkUtil.isNetworkConnected(this)) {
                    com.baidu.duer.dcs.sample.sdk.wakeup.LogUtil.i(TAG, "网络异常 3" );
                    Toast.makeText(this,
            ...
            case R.id.voiceBtn:
                if (!NetWorkUtil.isNetworkConnected(this)) {
                    com.baidu.duer.dcs.sample.sdk.wakeup.LogUtil.i(TAG, "网络异常 4" );
                    Toast.makeText(this,
                            getResources().getString(R.string.err_net_msg),
                            Toast.LENGTH_SHORT).show();
                    return;
